...
from server.auth import get_requester_did_from_request
...
def get_feed_skeleton():
    ...
    requester_did = get_requester_did_from_request(request)

    try:
        cursor = request.args.get('cursor', default=None, type=str)
        limit = request.args.get('limit', default=20, type=int)
        body = algo(cursor, limit, requester_did=requester_did)
    except ValueError:
